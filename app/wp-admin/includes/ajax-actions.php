...
function wp_ajax_imgedit_preview() {
	error_log("wp_ajax_imgedit_preview. Starting...");
	...
	error_log("wp_ajax_imgedit_preview. About to include image-edit.php");
	include_once( ABSPATH . 'wp-admin/includes/image-edit.php' );
	error_log("wp_ajax_imgedit_preview. Included image-edit.php");

	if ( ! stream_preview_image($post_id) ) {
		error_log("wp_ajax_imgedit_preview. stream_preview_image failed. about to die...");

...
function _load_image_to_edit_path( $attachment_id, $size = 'full' ) {
	...
	error_log("_load_image_to_edit_path -------------> Attachment ID: $attachment_id. size: $size");

	$filepath = get_attached_file( $attachment_id );

	error_log("_load_image_to_edit_path -------------> After get_attached_file. filepath: $filepath");
	...
	if ( $filepath && file_exists( $filepath ) ) {
		...
		error_log("_load_image_to_edit_path -------------> Not a file on the file system. Filters the image URL if not in the local filesystem.");

		$xxx_temp = wp_get_attachment_url( $attachment_id );

		error_log("_load_image_to_edit_path -------------> wp_get_attachment_url returns: $xxx_temp");
	...
	error_log("_load_image_to_edit_path -------------> Intermediate filepath: $filepath");
	...
	$filepath = apply_filters( 'load_image_to_edit_path', $filepath, $attachment_id, $size );

	error_log("_load_image_to_edit_path -------------> Final filepath: $filepath");

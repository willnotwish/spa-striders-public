...
class S3_Uploads_Image_Editor_Imagick extends WP_Image_Editor_Imagick {
	...
	public function load() {
		error_log("S3_Uploads_Image_Editor_Imagick#load. About to call parent::load()");
		$result = parent::load();
		error_log("S3_Uploads_Image_Editor_Imagick#load. parent::load() returned result " . print_r($result, true));

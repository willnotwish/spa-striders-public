...
class S3_Uploads {
	...
	public function filter_upload_dir( $dirs ) {
		// error_log("S3_Uploads#filter_upload_dir. Starting...");

		// error_log('S3_Uploads#filter_upload_dir. Unfiltered dirs: ' . print_r($dirs,true));
		...
		// error_log('S3_Uploads#filter_upload_dir. Filtered dirs: ' . print_r($dirs,true));
	...
	public function s3() {
		...
		// Added by Nick to support different endpoints (eg, DO Spaces)
		if( $this->endpoint ) {

...
class WP_Image_Editor_Imagick extends WP_Image_Editor {
	...
	public static function test( $args = array() ) {
		...
		if ( ! extension_loaded( 'imagick' ) || ! class_exists( 'Imagick', false ) || ! class_exists( 'ImagickPixel', false ) ) {
			error_log("WP_Image_Editor_Imagick.test returning false");
			return false;
		}
		...
		error_log("WP_Image_Editor_Imagick.test returning true");
		return true;
	}
	...
	public function load() {
		...
		error_log("WP_Image_Editor_Imagick#load. file: $this->file");

		if ( $this->image instanceof Imagick )
			return true;

		if ( ! is_file( $this->file ) ) {
			error_log("WP_Image_Editor_Imagick#load. $this->file is NOT a file");
		}
		...
		error_log("WP_Image_Editor_Imagick#load. Called wp_raise_memory_limit for image");
		...
		try {
			...
			error_log("WP_Image_Editor_Imagick#load. About to read image from $filename");
			$this->image->readImage( $filename );
			error_log("WP_Image_Editor_Imagick#load. Image read");
		...
		error_log("WP_Image_Editor_Imagick#load. About to call set_quality");
	...
	public function stream( $mime_type = null ) {
		error_log("WP_Image_Editor_Imagick. stream. Starting...");

		list( $filename, $extension, $mime_type ) = $this->get_output_format( null, $mime_type );

		error_log("WP_Image_Editor_Imagick. stream. filename: $filename, extension: $extension, mime_type: $mime_type");

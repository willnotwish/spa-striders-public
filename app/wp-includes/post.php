...
function get_attached_file( $attachment_id, $unfiltered = false ) {
	...
	error_log("get_attached_file. file (1): $file");
	...
	error_log("get_attached_file. file (2): $file");
...
function wp_get_attachment_url( $attachment_id = 0 ) {
	...
	error_log("wp_get_attachment_url. attachment_id: $attachment_id");
	...
	error_log("wp_get_attachment_url. url: $url");
	return $url;
}

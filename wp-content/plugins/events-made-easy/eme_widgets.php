...
class WP_Widget_eme_list extends WP_Widget {
   ...
   function __construct() {
      parent::__construct(
            'eme_list', // Base ID
            __('Events Made Easy List', 'events-made-easy'), // Name
...
?>
  ...
  <p>
    <label for="<?php echo $this->get_field_id('scope'); ?>"><?php _e('Scope of the events','events-made-easy'); ?><br /><?php _e('(See the doc for &#91;events_list] for all possible values)', 'events-made-easy'); ?>:</label><br />
